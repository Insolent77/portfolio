...
const translations = {
  ru: {
    ...
    fullCycle: 'Полный цикл', webApp: 'Веб-приложение',
    ...
    inProgress: 'Место для нового', futureTitle: 'Следующий проект',
    futureDescription: 'Здесь появится новый кейс. Возможно, именно тот, который мы создадим вместе.', futureCta: 'Обсудить идею',
  ...
  en: {
    ...
    fullCycle: 'Full cycle', webApp: 'Web application',
    ...
    inProgress: 'Space for something new', futureTitle: 'The next project',
    futureDescription: 'A new case will appear here. Perhaps it will be the one we create together.', futureCta: 'Discuss an idea',
